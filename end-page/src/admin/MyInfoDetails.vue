        ...
        >
          <el-form :model="form">
            <el-form-item label="头像" :label-width="formLabelWidth">
              <el-image
                style="width: 100px; height: 100px; vertical-align: bottom"
              ...
              <el-upload
                ...
                :action="$store.state.imgBaseUrl + 'upload/admin/avatar/' + form.id"
                :beforeUpload="updateAvatar"
              >
        ...
        <el-descriptions class="margin-top" :column="1" border :labelStyle="LS">
          <el-descriptions-item>
            ...
            <el-image
              ...
              v-if="myInfo.avatar != '' && form.avatar != null"
              :src="myInfo.avatar"
            >
            </el-image>
          </el-descriptions-item>
